...
<div class="entry">
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-firstname" />
				</label>
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-middlename" />
				</label>
				<span class="aui-field-element">
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-lastname" />
				</label>
				<span class="aui-field-element">
					<%= person.getLastname() %>
				</span>
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-kundedescription" />
				</label>
				<span class="aui-field-element">
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-userdocument" />
				</label>
				<span class="aui-field-element">
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-city" />
				</label>
				<span class="aui-field-element">
					<%= person.getCity() %>
				</span>
			...
			<span class="aui-field-content">
				<label class="aui-field-label"> 
					<liferay-ui:message key="qrperson-useremail" />
				</label>
				<span class="aui-field-element">
					<%= person.getUserEmail() %>
				</span>
