...
>
	<liferay-ui:section>
        ...
        <form name="setpersonPref" action="<portlet:actionURL name="setpersonPref" />" method="POST">
        <table border="0">
        	<tbody>
        		<tr>
        			<td>
	...
	<liferay-ui:section>
		<aui:button-row>
			...
			<input type="button" value="<%=LanguageUtil.get(pageContext,"prefs-export") %>"   onClick="location.href = '<portlet:resourceURL id="exportFullpersonResourceURL"></portlet:resourceURL>'" />
		</aui:button-row>
	</liferay-ui:section>
</liferay-ui:tabs>
