...
<% String requiredLabel=""; %>
	...
	<% requiredLabel ="*"; %>
			<aui:input name="Firstname" disabled="false" label='<%= LanguageUtil.get(pageContext, "kunde-firstname") + requiredLabel %>'/>
...
<% requiredLabel =""; %>
				...
				<liferay-ui:error key="kunde-firstname-required" message="kunde-firstname-required" />

			<aui:input name="Middlename" disabled="false" label='<%= LanguageUtil.get(pageContext, "kunde-middlename") + requiredLabel %>'/>
...
<% requiredLabel =""; %>
				...
				<liferay-ui:error key="kunde-middlename-required" message="kunde-middlename-required" />

	<% requiredLabel ="*"; %>
			<aui:input name="Lastname" disabled="false" label='<%= LanguageUtil.get(pageContext, "kunde-lastname") + requiredLabel %>'/>
...
<% requiredLabel =""; %>
				...
				<liferay-ui:error key="kunde-lastname-required" message="kunde-lastname-required" />
...
<% } %>
			...
			<aui:input name="City" disabled="false" label='<%= LanguageUtil.get(pageContext, "kunde-city") + requiredLabel %>'/>
...
<% requiredLabel =""; %>
				...
				<liferay-ui:error key="kunde-city-required" message="kunde-city-required" />
