...
>
	<liferay-ui:section>
        ...
        <form name="setkundePref" action="<portlet:actionURL name="setkundePref" />" method="POST">
        <table border="0">
        	<tbody>
        		<tr>
        			<td>
	...
	<liferay-ui:section>
		<aui:button-row>
			...
			<input type="button" value="<%=LanguageUtil.get(pageContext,"prefs-export") %>"   onClick="location.href = '<portlet:resourceURL id="exportFullkundeResourceURL"></portlet:resourceURL>'" />
		</aui:button-row>
	</liferay-ui:section>
</liferay-ui:tabs>
