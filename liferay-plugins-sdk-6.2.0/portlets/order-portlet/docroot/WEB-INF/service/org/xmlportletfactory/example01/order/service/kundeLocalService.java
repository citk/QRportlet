...
/**
 * Provides the local service interface for kunde. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jack A. Rider
 * @see kundeLocalServiceUtil
...
public interface kundeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link kundeLocalServiceUtil} to access the kunde local service. Add custom service methods to {@link org.xmlportletfactory.example01.order.service.impl.kundeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
